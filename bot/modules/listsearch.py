...
list_handler = CommandHandler(BotCommands.ListsearchCommand, list_buttons, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
